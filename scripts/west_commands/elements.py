...
GENERATE_USAGE = '''\
west elements-generate [-h] [-b BOARD] [-d BUILD_DIR]
'''
...
SYNTHESIZE_USAGE = '''\
west elements-synthesize [-h] [-b BOARD] [-d BUILD_DIR] [--vendor-xilinx VIVADO_BINARY]
'''
...
SIMULATE_USAGE = '''\
west elements-simulate [-h] [-b BOARD] [-d BUILD_DIR] [--duration DURATION_IN_MS] [--show-only]
'''
...
TEST_USAGE = '''\
west elements-test [-h] [-b BOARD] [-d BUILD_DIR] <application>
'''
